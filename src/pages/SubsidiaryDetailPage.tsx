      ...
      <section className="relative min-h-[260px] sm:min-h-[300px] flex items-end py-12 sm:py-16 px-6 sm:px-8 lg:px-16 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto">
          <AnimateOnScroll>
            ...
            <Link
              to="/subsidiaries"
              className="inline-flex items-center gap-1.5 text-xs font-sans text-primary-foreground/70 hover:text-primary-foreground transition-colors mb-5 group"
            >
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-5">
              ...
              <div>
                ...
                <p className="text-sm font-sans text-primary-foreground/70 mt-1">{entity.tagline}</p>
              </div>
            </div>
          </AnimateOnScroll>
        </div>
