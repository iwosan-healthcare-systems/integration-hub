...
export function UpcomingSessionsReminder() {
  ...
  return (
    <div className="fixed bottom-6 left-4 sm:left-6 z-40 w-[calc(100%-2rem)] max-w-sm rounded-2xl border border-border bg-card text-card-foreground shadow-2xl ring-1 ring-black/5 dark:ring-white/10 overflow-hidden animate-in slide-in-from-bottom-4 fade-in duration-300">
