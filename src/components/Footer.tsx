    ...
    <footer className="bg-iwosan-navy border-t border-white/10">
      <div className="max-w-6xl mx-auto px-8 lg:px-16 py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex items-center gap-2 mt-5">
            ...
            <span className="text-xs font-sans text-white/40 tracking-wide">Transforming Nigerian Healthcare</span>
          </div>
        </div>

        {/* Navigation */}
        <div>
          <h4 className="font-sans text-white/80 font-semibold text-xs uppercase tracking-widest mb-4">
            Navigate
          </h4>
          <nav className="space-y-2.5">
            {[
              ...
              <Link
                key={url}
                to={url}
                className="flex items-center gap-1.5 text-sm font-sans text-white/50 hover:text-accent transition-colors duration-200 group"
              >
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-2.5">
              ...
              <span className="text-sm font-sans text-white/50 leading-relaxed">Lagos, Nigeria</span>
            </div>
            <div className="flex items-center gap-2.5">
              <Phone className="h-4 w-4 text-accent shrink-0" />
              <a
                href="tel:+2349139352779"
                className="text-sm font-sans text-white/50 hover:text-accent transition-colors duration-200"
              >
                +234 913 935 2779
              </a>
            </div>
            <div className="flex items-center gap-2.5">
              ...
              <a
                ...
                className="text-sm font-sans text-white/50 hover:text-accent transition-colors duration-200 break-all"
              >
      ...
      <div className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-8 lg:px-16 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs font-sans text-white/20 tracking-wide uppercase">
