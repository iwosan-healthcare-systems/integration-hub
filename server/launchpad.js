...
export const STATUSES = { submitted: 'Idea Received', under_review: 'Under MD Review', successful: 'MD Approved', under_implementation: 'Under Implementation', concluded_pilot: 'Completed implementation', rejected: 'Parked' };
...
export function validateSubmission(input) {
  ...
  const answers = {};
  const fields = { department: ['Department',200], managerName: ['Line manager name',200], managerEmail: ['Line manager email',254], problem: ['The problem',5000], idea: ['Your idea',5000], implementationPlan: ['How will you implement this idea?',5000], duration: ['Expected time to achieve the objective',500], measurement: ['KPIs and outcomes',5000], owner: ['Project owner',200], risks: ['Project risks',5000] };
